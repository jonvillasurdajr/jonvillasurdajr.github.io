...
<img class="profile-image" src="{{ site.author.image | relative_url | escape }}" alt="Portrait of Jon G. Villasurda Jr." width="180" height="180" loading="eager" decoding="async" />
...
- **Public name:** Jon G. Villasurda Jr.
- **Also published as:** Jon Villasurda and Jon Villasurda Jr.
- **Current role:** Senior Principal, Mercer Government
- **Professional location:** Okemos, Michigan
- **Education:** Bachelor of Science in psychology and Master of Public Health in health management and policy, University of Michigan
- **Areas of focus:** Medicaid, behavioral health, CCBHC implementation, and public-sector analytics and evaluation

## Authoritative references

- [LinkedIn professional profile]({{ site.social_links.linkedin }})
- [Center for Health and Research Transformation biography]({{ site.social_links.chrt }})
- [GitHub profile]({{ site.social_links.github }})
...
- [Healthcare policy notes](/notes/)
- [Professional background](/work/)

This page is the concise, canonical professional profile for Jon G. Villasurda Jr. For a longer biography, visit the [about page](/about/).
